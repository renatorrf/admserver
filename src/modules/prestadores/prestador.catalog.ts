...
import { digits, optionalEmail } from '../../shared/validation/common.schemas';
import type { CatalogDefinition } from '../cadastros/catalog.types';

const fields = {
  nome: z.string().trim().min(2).max(150),
  cpf: digits(11, 'Informe um CPF com 11 digitos.'),
  ...
  validadeCnh: z.iso.date('Informe uma data de validade valida.'),
